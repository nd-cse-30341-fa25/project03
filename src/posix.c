...
void *malloc(size_t size) {
    ...
    // TODO: Search free list for any available block with matching size, split
    // and detach if found, otherwise allocate a new block
...
void *calloc(size_t nmemb, size_t size) {
    // TODO: Implement calloc using malloc and memset
...
void *realloc(void *ptr, size_t size) {
    // TODO: Implement realloc using malloc and memcpy
